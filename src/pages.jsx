...
const REGIONS_HOME = [
  {
    name: "Africa",
    coord: "2.00°N 21.75°E",
    count: "54 nations",
    highlight: "Safari & Heritage",
  },
  {
    name: "Americas",
    coord: "15.00°N 90.00°W",
    count: "35 nations",
    highlight: "Diverse Landscapes",
  },
  {
    name: "Asia",
    coord: "34.00°N 100.00°E",
    count: "48 nations",
    highlight: "Ancient Cultures",
  },
  {
    name: "Europe",
    coord: "54.00°N 15.00°E",
    count: "44 nations",
    highlight: "History & Art",
  },
  {
    name: "Oceania",
    coord: "22.00°S 140.00°E",
    count: "14 nations",
    highlight: "Island Paradises",
  },
];
    ...
    getAllCountries()
      .then((data) => {
        ...
        const featured = [...data]
          ...
          .filter(
            (c, i, arr) =>
              arr.findIndex((x) => x.region === c.region) === i || i < 40,
          )
          .slice(0, 12);
    ...
    <div>
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            className="absolute top-48 right-[12%] h-2 w-2 rounded-full bg-teal-300/50 animate-pulse-soft blur-sm"
            style={{ animationDelay: "0.4s" }}
          />
          <div
            className="absolute bottom-32 left-[18%] h-2 w-2 rounded-full bg-brass-300/50 animate-pulse-soft blur-sm"
            style={{ animationDelay: "0.8s" }}
          />
          <div
            className="absolute bottom-40 right-[22%] h-3 w-3 rounded-full bg-teal-300/60 animate-pulse-soft blur-sm"
        ...
        <div className="container-wide pt-20 pb-20 sm:pt-28 sm:pb-28 md:pt-36 md:pb-36 lg:pt-40 lg:pb-40 relative">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-brass-300/20 bg-brass-300/5 mb-8 animate-drift">
              ...
              <span className="font-mono text-[11px] tracking-[0.2em] uppercase text-brass-200">
            ...
            <p className="mt-8 text-lg sm:text-xl text-ink-200 max-w-2xl leading-relaxed font-light">
              Atlasora delivers comprehensive geospatial intelligence for 195
              nations. Real-time data, cultural insights, and strategic travel
              intelligence for the modern explorer.
            </p>
        ...
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-8">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <TrendingUp
                className="h-5 w-5 text-brass-300"
                strokeWidth={1.5}
              />
              <span className="eyebrow">Trending Destinations</span>
            </div>
            <h2 className="font-display text-2xl sm:text-3xl md:text-4xl text-parchment-50">
              Most Explored Coordinates
            </h2>
          </div>
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden bg-ink-700">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    <p className="coord">
                      {formatCoords(c.latlng?.[0], c.latlng?.[1])}
                    </p>
      ...
      <section className="container-wide section-pad">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-5">
          {REGIONS_HOME.map((r) => (
            <Link
              key={r.name}
              to={`/explore?region=${encodeURIComponent(r.name)}`}
              className="group relative rounded-2xl border border-ink-600 bg-ink-800/40 p-6 overflow-hidden transition-all duration-500 hover:border-brass-300/40 hover:-translate-y-2 hover:shadow-glow"
            >
              ...
              <div className="relative">
                <div className="flex items-start justify-between mb-6">
                  ...
                  <span className="font-mono text-xs text-brass-300/80 bg-brass-300/10 px-2 py-1 rounded-full">
                    {r.count}
                  </span>
                </div>
                <h3 className="font-display text-xl text-parchment-50 mb-2">
                  {r.name}
                </h3>
      ...
      <section className="container-wide section-pad">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          <FeatureCard
            ...
            desc="Real-time country profiles, currencies, languages, and coordinates sourced from authoritative global databases."
          />
          <FeatureCard
            icon={BookOpen}
            title="Comprehensive Guides"
            desc="Every destination includes detailed cultural insights, landmarks, and travel intelligence from verified sources."
          />
          <FeatureCard
            icon={Bookmark}
            title="Personal Atlas"
            desc="Build your custom collection of destinations. Save, organize, and access your travel intelligence anywhere."
          />
        </div>
      </section>
      ...
      <section className="container-wide pb-16 sm:pb-24 lg:pb-32">
        <div className="relative rounded-2xl sm:rounded-3xl border border-ink-600 bg-gradient-to-br from-ink-800/80 to-ink-900/80 p-8 sm:p-12 md:p-20 text-center overflow-hidden">
          ...
          <div className="relative">
            ...
            <h2 className="font-display text-3xl sm:text-4xl md:text-5xl text-parchment-50 text-balance mb-4 sm:mb-6">
              Your Global Atlas Awaits
            </h2>
            <p className="text-lg text-ink-300 max-w-2xl mx-auto leading-relaxed">
              Start building your personal collection of destinations. Save
              coordinates, track explorations, and access comprehensive travel
              intelligence.
            </p>
            <Link
              to="/explore"
              className="btn-primary mt-10 inline-flex !py-4 !px-10 text-lg"
            >
  ...
  return (
    <div className="flex items-center gap-3 sm:gap-4">
      <div className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-brass-300/10 border border-brass-300/20 shrink-0">
        <Icon
          className="h-5 w-5 sm:h-6 sm:w-6 text-brass-300"
          strokeWidth={1.5}
        />
      </div>
      <div className="min-w-0">
        <div className="font-display text-xl sm:text-2xl text-parchment-50">
          {value}
        </div>
        <div className="font-mono text-[10px] sm:text-xs text-ink-400 uppercase tracking-wider leading-tight">
          {label}
        </div>
      </div>
    </div>
  ...
  return (
    <div className="container-wide py-8 sm:py-10">
      <div className="page-header">
        ...
        <h1 className="font-display text-2xl sm:text-3xl md:text-4xl text-parchment-50">
          Chart your next destination
        </h1>
        <p className="text-ink-300 mt-2 max-w-xl text-sm sm:text-base">
          Search all 195 countries by name, capital, or region.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-4 mb-6">
        ...
        <div className="flex items-center gap-3 overflow-x-auto scrollbar-none pb-1">
          <span className="text-xs font-mono text-ink-400 uppercase tracking-wider shrink-0">
            Sort by
          </span>
          <div className="flex gap-1 rounded-full border border-ink-600 p-1 shrink-0">
            {SORTS.map((s) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-medium whitespace-nowrap transition-colors ${sort === s.key ? "bg-brass-300 text-ink-900" : "text-ink-300 hover:text-parchment-100"}`}
              >
                {s.label}
              </button>
            ))}
        ...
        <div className="relative -mx-4 sm:mx-0">
          ...
          >
            <button
              type="button"
              onClick={() => setRegion("")}
              className={`chip shrink-0 ${!region ? "chip-active" : ""}`}
            >
              All regions
            </button>
            {REGIONS_EXPLORE.map((opt) => (
              <button
                key={opt}
                type="button"
                onClick={() => setRegion(opt === region ? "" : opt)}
                className={`chip shrink-0 ${region === opt ? "chip-active" : ""}`}
              >
                {opt}
              </button>
            ))}
      ...
      {status === "error" && (
        <div className="flex flex-col items-center justify-center py-24 gap-4 text-center">
          ...
          <p className="text-parchment-200 max-w-sm">
            We couldn't chart the countries just now. The data source may be
            unreachable.
          </p>
        </div>
      )}
      {status === "ready" && filtered.length === 0 && (
        <div className="flex flex-col items-center justify-center py-24 gap-4 text-center px-6">
          ...
          <p className="text-ink-300 max-w-sm text-sm">
              ...
              >
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-ink-700/50">
                    <span className="text-xs text-ink-400">Learn more</span>
                    <ArrowRight
                      className="h-3.5 w-3.5 text-brass-300 transition-transform group-hover:translate-x-1"
                      strokeWidth={2}
                    />
                  </div>
                </div>
  ...
  useEffect(() => {
    ...
    getCountryByCode(code)
      .then(async (c) => {
        ...
        getWikiSummary(name)
          .then((s) => alive && setGuide(s))
          .catch(() => alive && setGuide(null));
        getUnsplashPhoto(`${name} landscape travel`, {
          width: 1600,
          height: 900,
        })
          .then((p) => alive && setHeroImg(p))
          .catch(() => {});

        if (lat != null && lng != null) {
          getAttractionsNear(lat, lng)
            .then((results) => alive && setAttractions(results))
            .catch(() => alive && setAttractions([]));
        }
      })
    ...
    getAllCountries()
      .then((all) => {
        ...
        const lookup = Object.fromEntries(
          all.map((c) => [c.cca3, c.name.common]),
        );
        const names = {};
    ...
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-4">
        <Compass
          ...
          strokeWidth={1.5}
        />
        <p className="coord">Charting coordinates…</p>
      </div>
    );
    ...
    return (
      <div className="container-wide py-20">
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-ink-800 border border-ink-600 mb-6">
            <MapPin className="h-10 w-10 text-ink-400" />
          </div>
          <h2 className="font-display text-3xl text-parchment-50 mb-4">
            Country Not Found
          </h2>
          <p className="text-ink-300 mb-8 max-w-md mx-auto">
            We couldn't find that country on the map. It may not be available in
            our current dataset.
          </p>
  ...
  return (
    <div>
      <section className="relative h-[45vh] sm:h-[50vh] min-h-[320px] sm:min-h-[380px] overflow-hidden">
        <img
          src={heroImg?.url || country.flags?.svg}
        ...
        <div className="relative container-wide h-full flex flex-col justify-between py-4 sm:py-6">
          <Link
            to="/explore"
            className="btn-ghost !text-parchment-100 w-fit bg-ink-950/40 backdrop-blur-sm text-sm"
          >
          ...
          <div>
            <div className="flex items-center gap-3 mb-2 sm:mb-3">
              <img
                ...
                alt=""
                className="h-7 w-10 sm:h-8 sm:w-12 object-cover rounded shadow-stamp"
              />
              <p className="coord">{formatCoords(lat, lng)}</p>
            </div>
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              <div className="min-w-0">
                <h1 className="font-display text-3xl sm:text-4xl md:text-6xl text-parchment-50 break-words">
                  {country.name.common}
                </h1>
                <p className="text-parchment-200 mt-1 text-sm sm:text-base line-clamp-2">
                  {country.name.official}
                </p>
              </div>
              <button
                type="button"
                onClick={() => toggleSave(country)}
                className={`btn-primary w-full sm:w-auto shrink-0 ${saved ? "!bg-ink-800 !text-brass-200 border border-brass-300/50" : ""}`}
              >
                <Bookmark
                  className={`h-4 w-4 ${saved ? "fill-current" : ""}`}
                />
                {saved ? "Saved to atlas" : "Save destination"}
              </button>
            </div>
          </div>
        </div>
        {heroImg?.credit?.name && (
          <a
            href={heroImg.credit.link}
            target="_blank"
            rel="noreferrer"
            className="absolute bottom-3 right-4 text-[10px] font-mono text-parchment-200/70 hover:text-parchment-100"
          >
            Photo: {heroImg.credit.name} / Unsplash
          </a>
        )}
      </section>
      ...
      <div className="container-wide py-8 sm:py-10 grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
        <div className="lg:col-span-2 space-y-10">
          ...
          <div>
            ...
            <h2 className="font-display text-2xl text-parchment-50 mb-4">
            ...
            {guide ? (
              <div className="card-stamp p-6">
                ...
                <a
                  href={guide.content_urls?.desktop?.page}
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-1.5 text-sm text-brass-300 hover:text-brass-200 mt-4"
                >
                  Read the full guide on Wikipedia{" "}
                  <ExternalLink className="h-3.5 w-3.5" />
                </a>
              </div>
            ) : (
              <p className="text-ink-400 text-sm">
                No guide summary available for this destination yet.
              </p>
            )}
          </div>
            ...
            {attractions.length > 0 ? (
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {attractions.map((a) => (
                  ...
                  >
                    <div className="h-16 w-full sm:h-20 sm:w-20 shrink-0 rounded-xl overflow-hidden bg-ink-700 flex items-center justify-center text-ink-400">
              ...
              <div className="card-stamp p-6 flex items-center gap-3 text-ink-400 text-sm">
                <MapPin className="h-4 w-4" />
                No catalogued landmarks found near this capital point yet.
              </div>
            )}
          </div>
        </div>
        ...
        <aside className="space-y-6">
          <div className="card-stamp p-6 space-y-5">
            ...
            <InfoRow icon={Globe2} label="Area">
              {country.area
                ? `${formatPopulation(Math.round(country.area))} km²`
                : "—"}
            </InfoRow>
...
function InfoRow({ icon: Icon, label, children }) {
  return (
    <div className="flex items-start gap-3">
      <Icon
        className="h-4 w-4 text-brass-300 mt-0.5 shrink-0"
        strokeWidth={1.5}
      />
      <div className="min-w-0">
        <p className="text-[11px] uppercase tracking-wide text-ink-400">
      ...
      TOPICS.map(async (t) => {
        try {
          const [summary, photo] = await Promise.all([
            getWikiSummary(t.title),
            getUnsplashPhoto(`${t.title} travel`, { width: 700, height: 500 }),
          ]);
          return { ...t, summary, photo };
        } catch {
          return { ...t, summary: null, photo: null };
        }
      }),
    ).then((res) => {
      if (alive) {
        setCards(res.filter((r) => r.summary));
        setStatus("ready");
      }
    });
    return () => {
  ...
  return (
    <div className="container-wide py-8 sm:py-10">
      <div className="page-header max-w-2xl">
        ...
        <h1 className="font-display text-2xl sm:text-3xl md:text-4xl text-parchment-50">
          Field-tested reading, before you go
        </h1>
        <p className="text-ink-300 mt-2 text-sm sm:text-base">
          Long-form context on cities, regions, and natural wonders — pulled
          from Wikipedia's open archive and refreshed live.
        </p>
      </div>
      ...
      {status === "loading" ? (
        <div className="flex flex-col items-center justify-center py-24 gap-4">
          <Compass
            ...
            strokeWidth={1.5}
          />
          <p className="coord">Gathering dispatches…</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-6">
          {cards.map((c) => (
            <a
              key={c.title}
              href={c.summary.content_urls?.desktop?.page}
              target="_blank"
              rel="noreferrer"
              className="card-stamp group flex flex-col"
            >
              <div className="relative aspect-[16/10] overflow-hidden bg-ink-700">
                ...
                <span className="absolute top-3 left-3 chip !py-1 !bg-ink-900/70 text-[11px]">
                  <BookOpen className="h-3 w-3" /> {c.tag}
                </span>
              </div>
              <div className="p-5 flex-1 flex flex-col">
                ...
                <p className="text-sm text-ink-300 mt-2 line-clamp-3 flex-1">
                  {c.summary.extract}
                </p>
                <span className="inline-flex items-center gap-1.5 text-sm text-brass-300 mt-4 group-hover:gap-2.5 transition-all">
                  Read the dispatch <ArrowRight className="h-3.5 w-3.5" />
                </span>
              </div>
            </a>
          ))}
  ...
  return (
    <div className="container-wide py-8 sm:py-10">
      <div className="page-header">
        ...
        <p className="text-ink-300 mt-2 text-sm sm:text-base">
          {saved.length > 0
            ? `${saved.length} place${saved.length !== 1 ? "s" : ""} stamped for later.`
            : "Nothing stamped yet — start exploring to build your collection."}
        </p>
      </div>
      ...
      {saved.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-24 gap-4 text-center px-6">
          <div className="flex h-14 w-14 items-center justify-center rounded-full border border-ink-600 bg-ink-800">
            <Bookmark className="h-6 w-6 text-brass-300" strokeWidth={1.5} />
          </div>
          <h3 className="font-display text-xl text-parchment-50">
            Your atlas is empty
          </h3>
          <p className="text-ink-300 max-w-sm text-sm">
            Save destinations from the explore page and they'll appear here,
            ...
            <div key={s.cca3} className="card-stamp group">
              <Link to={`/country/${s.cca3}`} className="block">
                <div className="relative aspect-[4/3] overflow-hidden bg-ink-700">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4">
                    <p className="coord">
                      {formatCoords(s.latlng?.[0], s.latlng?.[1])}
                    </p>
                    <h3 className="font-display text-xl text-parchment-50">
                      {s.name}
                    </h3>
              ...
              <div className="p-4 flex items-center justify-between">
                <div className="text-xs text-ink-300 flex items-center gap-1.5">
                  <Compass className="h-3.5 w-3.5" /> {s.region}
                </div>
                <button
                  onClick={() => removeSaved(s.cca3)}
                  className="flex items-center gap-1 text-xs text-ink-400 hover:text-coral-400 transition-colors"
                >
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-5 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Compass
            className="h-8 w-8 text-brass-300 mx-auto mb-4"
            strokeWidth={1.5}
          />
          ...
          <p className="text-ink-300 mt-2 text-sm">
            Sign in to reach your saved destinations.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card-stamp p-7 space-y-4">
          ...
          <div>
            <label className="text-xs uppercase tracking-wide text-ink-400 mb-1.5 block">
              Email
            </label>
            <input
              type="email"
        ...
        <p className="text-center text-sm text-ink-400 mt-6">
          New to Atlasora?{" "}
          <Link to="/signup" className="text-brass-300 hover:text-brass-200">
            Create an account
          </Link>
        </p>
        <p className="text-center text-xs text-ink-500 mt-3 font-mono">
          Demo auth — data stays in your browser only.
        </p>
      </div>
    </div>
  );
    ...
    <div className="min-h-[80vh] flex items-center justify-center px-5 py-16">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-ink-300 mt-2 text-sm">
            Create a free account to save destinations as you explore.
          </p>
        </div>
        ...
        <p className="text-center text-sm text-ink-400 mt-6">
          ...
          <Link to="/login" className="text-brass-300 hover:text-brass-200">
            Sign in
          </Link>
        </p>
        <p className="text-center text-xs text-ink-500 mt-3 font-mono">
  ...
  return (
    <div className="container-wide py-10">
      <div className="mb-8 flex items-center gap-4">
        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-brass-300/15 text-brass-200 font-display text-2xl">
          {user?.name?.[0]?.toUpperCase() ?? "A"}
        </div>
        <div>
          <h1 className="font-display text-2xl md:text-3xl text-parchment-50">
            {user?.name}
          </h1>
          <p className="text-ink-300 text-sm flex items-center gap-1.5 mt-1">
            <Calendar className="h-3.5 w-3.5" /> Charting since {memberSince}
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <form
          ...
          className="lg:col-span-2 card-stamp p-7 space-y-5"
        >
          ...
          <div>
            ...
            <input
              ...
              className="field-input"
              placeholder="Where do you set out from?"
            />
          </div>
          <div>
            <label className="text-xs uppercase tracking-wide text-ink-400 mb-1.5 block">
        ...
        <aside className="space-y-6">
          <div className="card-stamp p-6">
            <div className="flex items-center gap-2 mb-4">
              <Bookmark className="h-4 w-4 text-brass-300" />
              <h3 className="eyebrow">Atlas summary</h3>
            </div>
            <p className="font-display text-4xl text-parchment-50">
              {saved.length}
            </p>
            <p className="text-xs text-ink-400 mt-1">
              destination{saved.length !== 1 ? "s" : ""} saved
            </p>
            ...
            {regions.length > 0 && (
              <div className="mt-5 pt-5 border-t border-ink-700">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {regions.map((r) => (
                    <span key={r} className="chip !py-1 text-xs cursor-default">
            ...
            <Link
              to="/saved"
              className="btn-secondary w-full mt-5 !py-2.5 text-sm"
            >
              View saved atlas
            </Link>
          </div>
